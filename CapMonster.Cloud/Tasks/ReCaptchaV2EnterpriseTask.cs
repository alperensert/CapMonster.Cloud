...
public class ReCaptchaV2Enterprise : ITask, IProxyTask, IUserAgentTask, ICookieTask
{
    ...
    /// </summary>
    [JsonProperty("type")]
    private readonly string _type = "ReCaptchaV2EnterpriseTask";
    ...
    /// “gRecaptcha.enterprise.render” method along with the site key.
    /// </summary>
    ...
    /// may contain additional parameters that are passed to the
    /// “gRecaptcha.enterprise.render” method along with the site key.</param>
